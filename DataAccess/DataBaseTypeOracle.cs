...
namespace de.pta.Component.DataAccess.Internal
{
	...
	/// </pre>
	/// </remarks>
	internal class DataBaseTypeOracle : DataBaseType
	{
	#region Members
	...
	#region  Constructors
		...
		/// </summary>
		public DataBaseTypeOracle(Query query) : base(query)
		{
			initialize();
		}
	...
	#region Methods
		...
		{
			DBConnectionInfo dbConnectionInfo =  DBConnectionInfoFactory.GetInstance().GetDBConnectionInfo(DBConnectionInfo.TYPE_ORACLE);
		...
		private void processQuery()
		{
			...
			OracleCommand currentCommand  = new OracleCommand();
			currentCommand.CommandType = CommandType.Text;
			currentCommand.Connection  = (OracleConnection)dbConnection;
