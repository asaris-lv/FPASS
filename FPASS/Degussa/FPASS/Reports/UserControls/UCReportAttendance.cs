...
{
	/// <summary>
	/// This control is bound into the reports form and shows coworkers with bookings (dynamic data) and attendance times
	/// </summary>
	/// <remarks>
	...
	/// </div>
	/// </remarks>
	public class UCReportAttendance : UserControl
	{
		...
		private void InitializeComponent()
		{
            ...
            this.DgrTextBoxAccess.Width = 70;
            // 
            // DgrTextBoxSurname
            // 
            ...
            this.DgrTextBoxDebitNo.HeaderText = "Debitorennr.";
            this.DgrTextBoxDebitNo.MappingName = "ExContractorDebitNo";
            this.DgrTextBoxDebitNo.NullText = "";
            this.DgrTextBoxDebitNo.Width = 110;
            // 
            ...
            this.DgrTextBoxSurnameCoord.Width = 170;
            // 
		...
		/// <summary>
		/// Raised when user enters grid. Only useful if a record is selected
		/// </summary>
		...
		/// <summary>
		/// Raised when user moves cell. Only useful if records present
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		...
		/// <summary>
		/// Raised whhen datasource changed, re-inialises currently selected CWR id
